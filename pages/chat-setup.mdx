...
Chat can be great for teams who want to talk to their customers quickly and directly on your own website.

There are two ways to use chat with Plain: using a simple **script tag** or using our **React chat library**
