...
A customer can be added to a customer group using the `addCustomerToCustomerGroup` mutation. Here are some examples of when you might want to add a customer to a group:

- Immediately assign them their relevant groups when they're created in Plain, e.g. because their email address belongs to a particular company
- If you're grouping your customers by pricing tier, you could change their groups when they upgrade their subscription
