...
UI components are a way of describing some UI when using Plain's [Customer Timeline Entries](/custom-timeline-entries)
and [Customer Cards](/customer-cards).
...
<ImageContainer withBorder={true}>
  ![Example button linking to stripe](/images/ui-components/link-button-stripe.png)
</ImageContainer>
