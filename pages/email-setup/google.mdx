...
# Receiving emails in Plain from Google
...
<ImageContainer>![Add new rule](/images/email-setup/email-setup-0.png)</ImageContainer>
...
<ImageContainer>![Replace recipient](/images/email-setup/email-setup-2.png)</ImageContainer>

### Set who the rule applies to

Scroll further down, and choose "Perform this action on non-recognised and recognised addresses"

<ImageContainer>![Apply to all addresses](/images/email-setup/email-setup-3.png)</ImageContainer>
